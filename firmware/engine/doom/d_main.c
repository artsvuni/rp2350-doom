...
void D_DoomLoop (void)
{
...
#endif
#if PICO_ON_DEVICE
    bootlog_print("16: before I_InitGraphics");
#endif
    I_InitGraphics();
#if PICO_ON_DEVICE
    ...
    EnableLoadingDisk();
#if PICO_ON_DEVICE
    bootlog_print("18: EnableLoadingDisk OK");
#endif

    TryRunTics();
#if PICO_ON_DEVICE
    bootlog_print("19: TryRunTics OK");
#endif

    V_RestoreBuffer();
    R_ExecuteSetViewSize();
#if PICO_ON_DEVICE
    bootlog_print("20: R_ExecuteSetViewSize OK");
#endif
...
//    }
...
#if PICO_ON_DEVICE
    bootlog_print("5: D_DoomMain entered");
#endif
    DEH_printf("Z_Init: Init zone memory allocation daemon. \n");
#if PICO_ON_DEVICE
    bootlog_print("5b: before Z_Init()");
#endif
    Z_Init ();
#if PICO_ON_DEVICE
    bootlog_print("6: Z_Init OK");
#endif
...
#if PICO_ON_DEVICE
    bootlog_print("7: before D_AddFile (WAD open)");
#endif
#if !NO_FILE_ACCESS && !DOOM_TINY
    D_AddFile(iwadfile);
#else
...
#endif
#if PICO_ON_DEVICE
    bootlog_print("9: IdentifyIWADByName OK");
#endif
    ...
    InitGameVersion();
#if PICO_ON_DEVICE
    bootlog_print("10: D_IdentifyVersion OK");
#endif
...
//    W_PrintDirectory();
...
#if PICO_ON_DEVICE
    bootlog_print("10b: before M_Init");
#endif
    DEH_printf("M_Init: Init miscellaneous info.\n");
    M_Init ();
#if PICO_ON_DEVICE
    bootlog_print("10c: M_Init OK");
#endif

#if PICO_ON_DEVICE
    bootlog_print("11: before R_Init");
#endif
    DEH_printf("R_Init: Init DOOM refresh daemon - ");
    R_Init ();
#if PICO_ON_DEVICE
    bootlog_print("12: R_Init OK");
#endif

    DEH_printf("\nP_Init: Init Playloop state.\n");
    P_Init ();
#if PICO_ON_DEVICE
    bootlog_print("13: P_Init OK");
#endif

    DEH_printf("S_Init: Setting up sound.\n");
    S_Init (sfxVolume * 8, musicVolume * 8);
#if PICO_ON_DEVICE
    bootlog_print("14: S_Init OK");
#endif
    ...
    D_CheckNetGame ();
#if PICO_ON_DEVICE
    bootlog_print("15: D_CheckNetGame OK");
#endif
